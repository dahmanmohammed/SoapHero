//-----------------------------------------------------------------------
// <copyright file="SpriteAnimation.cs" company="Collège La Cité">
...
namespace SoapHero
{
    ...
    public abstract class SpriteAnimation : Sprite
    {
        ...
        /// </summary>
        /// <value>Texture du sprite dans son état actuel.</value>
        ...
        /// </summary>
        /// <value>Largeur (en pixels) de la tuile d'affichage courante.</value>
        ...
        /// tuiles de palette exploitées dans l'animation.
        /// </summary>
        /// <value>Hauteur (en pixels) de la tuile d'affichage courante.</value>
        ...
        /// <summary>
        /// Propriété retournant la vitesse d'animation du sprite.
        /// </summary>
        ...
        /// </summary>
        /// <value>Palette contenant les tuiles d'animation.</value>
        ...
        /// <summary>
        /// Propriété retournant la tuile d'animation présentement affichée par Draw.
        /// </summary>
        /// <value>Index de la tuile d'affichage courante.</value>
        ...
        /// <summary>
        /// Affiche à l'écran le sprite en fonction de la position de la camera fournie. L'affichage est
        /// déléguée à palette afin d'afficher la tuile courante d'animation. 
        /// RAPPEL : on n'utilise pas la fonction membre héritée Sprite.Draw() car celle-ci exploite 
        /// l'accesseur Texture, qu'on veut éviter d'utiliser par soucis d'efficacité.
        /// </summary>
        ...
        public override void Draw(Rectangle cameraRect, SpriteBatch spriteBatch, Color? color)
        {
            ...
            this.PaletteAnimation.Draw(this.IndexTuile, destRect, spriteBatch, color);
        }
    }
}
